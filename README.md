...
# Features
 ...
 - The `upgrade` operand has 3 flags, -a to upgrade every package, -s to upgrade/downgrade specified packages to a different version than currently installed and -n to upgrade specified packages to the latest stable version
